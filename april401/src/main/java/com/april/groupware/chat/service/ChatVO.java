...
public class ChatVO extends DTO {
	...
	public ChatVO(String id, String password, String deptNm, String deptCd, String parentDeptCd, String auth,
	...
	public String toString() {
		return "ChatVO [id=" + id + ", password=" + password + ", deptNm=" + deptNm + ", deptCd=" + deptCd
