 ...
 * </pre>
 */
package com.april.groupware.login.service;
 ...
 *
 */
public class LoginVO extends DTO {
	/** 아이디 */
	private String id;
	/** 비밀번호 */
	...
	public LoginVO(String id, String password, String deptNm, String deptCd, String parentDeptCd, String auth,
