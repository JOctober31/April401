...
public class TodoController {
	...
	public String doRetrieve(SearchVO  search,Model model) {
		...
		/*
		 * //검색조건 CodeVO code=new CodeVO(); code.setCodeTypeId("TODO_SEARCH");
		...
		return "todo/todo_list";// "/board/board_list.jsp
	}
...
//	@RequestMapping(value = "todo/do_insert.do",method = RequestMethod.GET)
