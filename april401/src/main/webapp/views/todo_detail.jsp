                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="${hContext}/todo/doREtrieve.do" method="post">
                                        ...
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="pTitle" name="pTitle" placeholder="Choose a pTitle">
                                            </div>
                                        </div>
                                        <div class="form-group row">
